...
- **Service Account** Setup. See "Safe investigation" skill in SRE Extension. The name will be `safe-sre-investigator@...`.
  - We also have some sort of local authenticated JSON key to allow the docker container 
