...
- **Service Account** Setup. See "Safe investigation" skill in SRE Extension. The name will be `safe-sre-investigator@<PROJECT_ID>.iam.gserviceaccount.com` (authenticated via SA impersonation or local JSON key files depending on org policies).
